...
function displayMyCv() {
  navLi[2].addEventListener("click", (e) => {
    /* Lien My Cv de la navbar */
...
function displayMyTitle() {
  navLi[3].addEventListener("click", (e) => {
    /* Lien My Title de la navbar */
    sectionHome.style.display = "none";
    sectionMyCv.style.display = "none";
...
function displayMyRealisations() {
  navLi[1].addEventListener("click", (e) => {
    /* Lien My Realisations de la navbar */
...
footerLinkGit.addEventListener("mouseover", (e) => {
  /*2 paramètre ????*/
  ...
  footerLinkGit.style.color = "rgb(178,34,34)";
  footerLinkGit.style.textShadow = "1px 1px grey";
...
footerLinkGit.addEventListener("mouseleave", (e) => {
  ...
  footerLinkGit.style.color = "darkgreen";
  e.preventDefault();
});
