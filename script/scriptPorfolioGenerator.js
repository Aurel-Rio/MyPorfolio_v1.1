...
if (stateSelect.value == "bgColor") {
  green.addEventListener("click", (e) => {
    document.body.style.background =
      "linear-gradient(125deg, rgb(0, 36, 15) 34.7%, rgba(255,255,255,8) 32%, rgba(2,0,36,1) 35%, rgb(9, 121, 52) 35%, rgb(0, 255, 55) 100%) ";
    blue.addEventListener("click", (e) => {
      document.body.style.background =
        "linear-gradient(125deg, rgba(2,0,36,1) 34.7%, rgba(255,255,255,1) 32%, rgba(2,0,36,1) 35%, rgba(9,9,121,1) 35%, rgba(0,212,255,1) 100%) ";
      red.addEventListener("click", (e) => {
        document.body.style.background =
          "linear-gradient(125deg, rgb(36, 0, 0) 34.7%, rgba(255,255,255,1) 32%, rgb(36, 0, 0) 35%, rgb(121, 9, 9) 35%, rgb(255, 0, 0) 100%)";
      });
    });
  });
} else if (stateSelect.value == "bgColor") {
